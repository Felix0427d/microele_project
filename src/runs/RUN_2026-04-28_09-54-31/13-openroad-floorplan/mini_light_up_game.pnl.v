module mini_light_up_game (btn,
 ...
 sky130_fd_sc_hd__dfrtp_2 _184_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(btn_prev));
 sky130_fd_sc_hd__conb_1 _185_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(seg0[6]));
 sky130_fd_sc_hd__conb_1 _186_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(seg1[6]));
 sky130_fd_sc_hd__conb_1 _187_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(seg2[6]));
 sky130_fd_sc_hd__conb_1 _188_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(seg3[6]));
